  ...
  const projects = [
    {
      ...
      // Example demoVideoUrl (replace with actual if available in content)
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            {demoVideoUrl && (
                <div className="max-w-4xl mx-auto rounded-xl overflow-hidden shadow-2xl border border-border bg-black aspect-video relative group">
                    {demoVideoUrl.includes('youtube.com') || demoVideoUrl.includes('youtu.be') ? (
                         <iframe 
                            src={demoVideoUrl.replace('watch?v=', 'embed/')} 
                            className="w-full h-full"
                            title="SomniaForge Demo"
